 ...
 */
@Mapper
public interface AppNodeDefinitionConverter extends BaseBeanConverter<AppNodeDefinition,AppNodeDefinitionEntity> {

    AppNodeDefinitionConverter INSTANCE = Mappers.getMapper(AppNodeDefinitionConverter.class);
