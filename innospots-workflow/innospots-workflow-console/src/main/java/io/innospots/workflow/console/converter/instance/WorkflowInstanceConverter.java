...
package io.innospots.workflow.console.converter.instance;
 ...
 */
@Mapper
public interface WorkflowInstanceConverter extends BaseBeanConverter<WorkflowInstance,WorkflowInstanceEntity> {
