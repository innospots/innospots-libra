 ...
 */
@Mapper
public interface AppNodeGroupBeanConverter extends BaseBeanConverter {

    AppNodeGroupBeanConverter INSTANCE = Mappers.getMapper(AppNodeGroupBeanConverter.class);
    ...
    default AppNodeGroupBaseInfo modelToBase(AppNodeGroup nodeGroup) {
        ...
        if (CollectionUtils.isNotEmpty(nodeGroup.getNodes())) {
            baseInfo.setNodes(AppNodeDefinitionBeanConverter.INSTANCE.modelToInfoList(nodeGroup.getNodes()));
        }
        return baseInfo;
    }
