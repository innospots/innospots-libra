 ...
 */
@Mapper
public interface AppNodeDefinitionBeanConverter extends BaseBeanConverter {

    AppNodeDefinitionBeanConverter INSTANCE = Mappers.getMapper(AppNodeDefinitionBeanConverter.class);
