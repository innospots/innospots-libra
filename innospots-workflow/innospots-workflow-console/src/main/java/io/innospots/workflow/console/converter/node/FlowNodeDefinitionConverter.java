...
package io.innospots.workflow.console.converter.node;
 ...
 */
@Mapper
public interface FlowNodeDefinitionConverter extends BaseBeanConverter<AppNodeDefinition, FlowNodeDefinitionEntity> {

    FlowNodeDefinitionConverter INSTANCE = Mappers.getMapper(FlowNodeDefinitionConverter.class);

    FlowNodeDefinitionEntity infoToEntity(AppInfo appInfo);

    AppInfo modelToSimple(AppNodeDefinition model);

    AppInfo entityToSimple(FlowNodeDefinitionEntity entity);
    ...
    void modelToEntity(AppNodeDefinition model, @MappingTarget FlowNodeDefinitionEntity entity);

    @Mapping(target = "icon", ignore = true)
    void infoToEntity(AppInfo appInfo, @MappingTarget FlowNodeDefinitionEntity entity);
