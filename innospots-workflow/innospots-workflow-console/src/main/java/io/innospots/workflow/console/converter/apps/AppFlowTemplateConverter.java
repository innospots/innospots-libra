 ...
 */
@Mapper
public interface AppFlowTemplateConverter extends BaseBeanConverter<AppFlowTemplate,AppFlowTemplateEntity> {

    AppFlowTemplateConverter INSTANCE = Mappers.getMapper(AppFlowTemplateConverter.class);
