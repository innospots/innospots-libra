 ...
 */
@Mapper
public interface FlowTemplateConverter extends BaseBeanConverter<FlowTemplate, FlowTemplateEntity> {
     ...
     * @return
     */
    List<FlowTemplateBase> entityToBaseModelList(List<FlowTemplateEntity> list);
     ...
     * @return
     */
    FlowTemplateEntity baseModelToEntity(FlowTemplateBase model);
