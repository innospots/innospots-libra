...
@Getter
@Setter
public class NodeExecutionEventBody extends EventBody {

    public NodeExecutionEventBody(ScheduledNodeExecution scheduledNodeExecution) {
        this.body = scheduledNodeExecution;
    }
}
