...
package io.innospots.libra.kernel.module.workspace.converter;
 ...
 */
@Mapper
public interface WorkspaceBeanConverter extends BaseBeanConverter<Workspace,WorkspaceEntity> {

    WorkspaceBeanConverter INSTANCE = Mappers.getMapper(WorkspaceBeanConverter.class);
