 ...
 */
@Mapper
public interface UserInfoBeanConverter extends BaseBeanConverter<UserInfo,SysUserEntity> {

    UserInfoBeanConverter INSTANCE = Mappers.getMapper(UserInfoBeanConverter.class);
