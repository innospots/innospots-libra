...
import io.innospots.libra.kernel.module.page.converter.WidgetConverter;
...
public class WidgetOperator extends ServiceImpl<WidgetDao, WidgetEntity> {
    ...
    public List<Widget> list(Integer pageId) {
        ...
        List<Widget> widgets = WidgetConverter.INSTANCE.entitiesToModels(entities);
    ...
    public List<Widget> createOrUpdate(List<Widget> widgets) {
        List<WidgetEntity> entities = WidgetConverter.INSTANCE.modelsToEntities(widgets);
