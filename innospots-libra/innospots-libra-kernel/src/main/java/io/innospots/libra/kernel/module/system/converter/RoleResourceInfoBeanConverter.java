 ...
 */
@Mapper
public interface RoleResourceInfoBeanConverter extends BaseBeanConverter<RoleResourceInfo,RoleResourceEntity> {

    RoleResourceInfoBeanConverter INSTANCE = Mappers.getMapper(RoleResourceInfoBeanConverter.class);
