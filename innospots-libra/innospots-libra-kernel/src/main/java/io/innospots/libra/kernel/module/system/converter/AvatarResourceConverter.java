 ...
 */
@Mapper
public interface AvatarResourceConverter extends BaseBeanConverter<AvatarInfo,AvatarResourceEntity> {

    AvatarResourceConverter INSTANCE = Mappers.getMapper(AvatarResourceConverter.class);
