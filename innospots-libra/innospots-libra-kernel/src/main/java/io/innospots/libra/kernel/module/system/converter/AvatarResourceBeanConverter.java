 ...
 */
@Mapper
public interface AvatarResourceBeanConverter extends BaseBeanConverter<AvatarInfo,AvatarResourceEntity> {

    AvatarResourceBeanConverter INSTANCE = Mappers.getMapper(AvatarResourceBeanConverter.class);
