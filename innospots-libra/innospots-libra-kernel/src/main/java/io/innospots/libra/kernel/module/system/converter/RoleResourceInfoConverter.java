 ...
 */
@Mapper
public interface RoleResourceInfoConverter extends BaseBeanConverter<RoleResourceInfo,RoleResourceEntity> {

    RoleResourceInfoConverter INSTANCE = Mappers.getMapper(RoleResourceInfoConverter.class);
