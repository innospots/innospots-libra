 ...
 */
@Mapper
public interface AppInstallmentBeanConverter extends BaseBeanConverter {

    AppInstallmentBeanConverter INSTANCE = Mappers.getMapper(AppInstallmentBeanConverter.class);
