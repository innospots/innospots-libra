 ...
 */
@Mapper
public interface AvatarResourceMapper {

    AvatarResourceMapper INSTANCE = Mappers.getMapper(AvatarResourceMapper.class);

    AvatarInfo entity2Model(AvatarResourceEntity entity);
}