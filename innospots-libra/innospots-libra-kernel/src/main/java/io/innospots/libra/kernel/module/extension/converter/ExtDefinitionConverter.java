 ...
 */
@Mapper
public interface ExtDefinitionConverter extends BaseBeanConverter<ExtensionDefinition,ExtDefinitionEntity> {

    ExtDefinitionConverter INSTANCE = Mappers.getMapper(ExtDefinitionConverter.class);
