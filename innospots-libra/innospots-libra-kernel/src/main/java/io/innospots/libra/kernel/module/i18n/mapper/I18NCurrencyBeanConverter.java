 ...
 */
@Mapper
public interface I18NCurrencyBeanConverter extends BaseBeanConverter {
    I18NCurrencyBeanConverter INSTANCE = Mappers.getMapper(I18NCurrencyBeanConverter.class);
