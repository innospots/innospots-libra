 ...
 */
@Mapper
public interface TodoTaskCommentConverter extends BaseBeanConverter<TodoTaskComment,TodoTaskCommentEntity> {

    TodoTaskCommentConverter INSTANCE = Mappers.getMapper(TodoTaskCommentConverter.class);
