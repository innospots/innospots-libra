...
package io.innospots.libra.kernel.module.extension.converter;
 ...
 */
@Mapper
public interface AppInstallmentConverter extends BaseBeanConverter<ExtensionInstallInfo,ExtInstallmentEntity> {

    AppInstallmentConverter INSTANCE = Mappers.getMapper(AppInstallmentConverter.class);
