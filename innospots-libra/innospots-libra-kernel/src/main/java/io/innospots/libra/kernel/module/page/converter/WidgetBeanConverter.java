...
package io.innospots.libra.kernel.module.page.converter;
 ...
 */
@Mapper
public interface WidgetBeanConverter extends BaseBeanConverter<Widget,WidgetEntity> {
    WidgetBeanConverter INSTANCE = Mappers.getMapper(WidgetBeanConverter.class);
