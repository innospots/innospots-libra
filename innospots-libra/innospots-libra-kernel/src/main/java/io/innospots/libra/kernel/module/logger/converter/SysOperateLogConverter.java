...
package io.innospots.libra.kernel.module.logger.converter;
 ...
 */
@Mapper
public interface SysOperateLogConverter extends BaseBeanConverter<SysOperateLog,SysOperateLogEntity> {
