 ...
 */
@Mapper
public interface TodoTaskConverter extends BaseBeanConverter<TodoTask,TodoTaskEntity> {

    TodoTaskConverter INSTANCE = Mappers.getMapper(TodoTaskConverter.class);
