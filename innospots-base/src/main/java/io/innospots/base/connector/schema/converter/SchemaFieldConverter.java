...
package io.innospots.base.connector.schema.converter;
 ...
 */
@Mapper
public interface SchemaFieldConverter extends BaseBeanConverter<SchemaField, SchemaFieldEntity> {

    SchemaFieldConverter INSTANCE = Mappers.getMapper(SchemaFieldConverter.class);
