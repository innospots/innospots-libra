 ...
 * @date 2021/12/21
 */
public class CustomerLocalTimeDeserializer extends StdDeserializer<LocalTime> {

    protected CustomerLocalTimeDeserializer(Class<LocalTime> vc) {
        super(vc);
    }

    public static CustomerLocalTimeDeserializer getInstance() {
        return new CustomerLocalTimeDeserializer(LocalTime.class);
    }
