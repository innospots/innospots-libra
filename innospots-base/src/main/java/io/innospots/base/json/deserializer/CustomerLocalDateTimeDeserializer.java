 ...
 * @date 2021/12/21
 */
public class CustomerLocalDateTimeDeserializer extends StdDeserializer<LocalDateTime> {


    protected CustomerLocalDateTimeDeserializer(Class<LocalDateTime> vc) {
        super(vc);
    }

    public static CustomerLocalDateTimeDeserializer getInstance() {
        return new CustomerLocalDateTimeDeserializer(LocalDateTime.class);
    }
