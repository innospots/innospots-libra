 ...
 * @date 2021/12/21
 */
public class CustomerLocalDateSerializer extends StdSerializer<LocalDate> {


    protected CustomerLocalDateSerializer(Class<LocalDate> t) {
        super(t);
    }

    public static CustomerLocalDateSerializer getInstance() {
        return new CustomerLocalDateSerializer(LocalDate.class);
    }
    ...
    public void serialize(LocalDate date, JsonGenerator g, SerializerProvider provider) throws IOException {
        ...
        g.writeString(formatter.format(date));
    }
}
