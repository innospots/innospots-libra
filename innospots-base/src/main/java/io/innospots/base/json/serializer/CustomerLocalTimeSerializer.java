 ...
 * @date 2021/12/21
 */
public class CustomerLocalTimeSerializer extends StdSerializer<LocalTime> {

    protected CustomerLocalTimeSerializer(Class<LocalTime> t) {
        super(t);
    }


    public static CustomerLocalTimeSerializer getInstance() {
        return new CustomerLocalTimeSerializer(LocalTime.class);
    }
    ...
    public void serialize(LocalTime value, JsonGenerator g, SerializerProvider provider) throws IOException {
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern(localeContext.getTimeFormat())
