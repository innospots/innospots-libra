...
import io.innospots.connector.core.schema.dao.SchemaFieldDao;
import io.innospots.connector.core.schema.entity.SchemaFieldEntity;
import io.innospots.base.exception.ResourceException;
import io.innospots.base.exception.ValidatorException;
import io.innospots.base.json.JSONUtils;
import io.innospots.base.model.field.FieldScope;
import io.innospots.connector.core.schema.converter.SchemaFieldConverter;
...
public class SchemaFieldOperator extends ServiceImpl<SchemaFieldDao, SchemaFieldEntity> {
    ...
    public List<SchemaField> createOrUpdateSchemaFieldBatch(String registryId, List<SchemaField> schemaFields) {
        ...
        entities = SchemaFieldConverter.INSTANCE.modelsToEntities(addFields);
    ...
    public List<SchemaField> listByRegistryId(String registryId) {
        ...
        return SchemaFieldConverter.INSTANCE.entitiesToModels(entities);
    }
    ...
    public SchemaField createSchemaField(SchemaField schemaField) {
        ...
        SchemaFieldEntity entity = SchemaFieldConverter.INSTANCE.modelToEntity(schemaField);
        super.save(entity);
