...
package io.innospots.connector.core.config;
...
import io.innospots.connector.core.schema.reader.CachedSchemaRegistryReader;
...
import io.innospots.connector.core.schema.operator.SchemaRegistryOperator;
import io.innospots.connector.core.schema.reader.SchemaRegistryReader;
 ...
 */
@Configuration
@EntityScan(basePackages = "io.innospots.connector.core.schema.entity")
@MapperScan(basePackages = "io.innospots.connector.core.schema.dao")
