...
package io.innospots.script.function.definition.configuration;

import io.innospots.script.function.definition.loader.FunctionDbLoader;
...
@Component
@Configuration
@EntityScan(basePackages = "io.innospots.script.function.definition.entity")
@MapperScan(basePackages = "io.innospots.script.function.definition.dao")
