...
package io.innospots.script.base.jit;
...
//    private String sourcePath;
    ...
    private JavaSourceFileStaticBuilder initialize() {
        this.addImport("import io.innospots.script.base.java.ParamName;")
                .addImport("import io.innospots.script.base.java.ScriptMeta;")
                .addImport("import io.innospots.base.json.JSONUtils;")
                .addImport("import io.innospots.script.base.OutputMode;")
                ...
                .addImport("import org.slf4j.LoggerFactory;")
                .addImport("import static io.innospots.script.base.function.HttpFunc.*;")
